...
while run,
    ...
    if any(d==-inf),
        ...
        PatchGraph(T,n,P,...
            ...
            'nodetextsize',6,...
            'nodemarkersize',10,...
            'edgetxt',E(ismember(E,T)),num2cell(c(ismember(E,T))),... % display only wanted stuff with 'ismember'
            'archdmu',.9,...
            'edgecolor','r',...
            'edgewidth',2,...
            'edgename','cycle',...
        ...
        % delete any arc of the cycle from the graph (inspired by pg. 80)
